...
<head>
    ...
    <title>Notificação PlatTrust</title>
    
    <style>
        /* Resets básicos para garantir que o Gmail, Apple Mail e Outlook exibam igual */
            ...
            <tr>
                <td style="background-color: #f8fafc; padding: 25px 40px; text-align: center; border-top: 1px solid #e2e8f0;">
                    <p style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 13px; line-height: 1.5; color: #94a3b8; margin: 0;">
                        Este é um e-mail automático gerado pelo sistema de auditoria e segurança <strong>PLATTrust</strong>.<br>
